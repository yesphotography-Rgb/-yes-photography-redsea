...
const packages = [
  { slug: "couple-romance", title: "Couple Romance", price: "From €90", desc: "Romantic sunset sessions" },
  { slug: "flying-dress", title: "Flying Dress Experience", price: "From €129", desc: "Iconic Instagram shots" },
  { slug: "family-memories", title: "Family Beach Memories", price: "From €109", desc: "Fun & natural family photos" },
  { slug: "honeymoon-bliss", title: "Honeymoon Bliss", price: "From €119", desc: "Luxury for newlyweds" }
];
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {packages.map((pkg) => (
          <div key={pkg.slug} className="card hover:border-gold transition-all">
            ...
            <p className="text-3xl font-bold text-gold mb-6">{pkg.price}</p>
            <Link 
